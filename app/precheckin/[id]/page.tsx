...
export default function PrecheckinPage({ params }: { params: { id: string } }) {
  ...
  const handleAddTraveler = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Si comparte dirección con el titular, no mandamos nada propio: el
      // backend hereda automáticamente la del titular al comunicar a SES.
              ...
              {addingTraveler ? (
                <form onSubmit={handleAddTraveler} className="border-t border-stone-100 pt-4">
                  ...
                  <label className="flex items-center gap-2 text-sm text-stone-600 mb-3">
                    ...
                    />
                    Vive en la misma dirección que el titular ({form.addressStreet || "…"})
                  </label>
                  ...
                  {!travelerForm.sameAddressAsLead && (
                    <div className="border border-stone-200 rounded p-3 mb-3">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-3 mb-3">
                        ...
                        <div>
                          <label className="label mb-1">Código postal *</label>
                          <input
                            type="text"
                            className="input"
                      ...
                      {(travelerForm.addressCountry.toUpperCase() === "ES" ||
                        travelerForm.addressCountry.toUpperCase() === "ESP") && (
                        <div>
                          <label className="label mb-1">Código INE del municipio (5 dígitos) *</label>
                          <input
                            type="text"
                            className="input"
